...
return (
  ...
  <div className="w-full ">
    ...
    <div className="flex justify-center items-start p-0 mt-10">  {/* Adjust this line */}
      <div className="w-full max-w-lg p-8 h-fit">
        <h2 className="text-4xl font-semibold text-gray-600 text-left">Sign up</h2>
  ...
  {signUpState===true && (
        <SuccessBox 
          ...
          description="You have successfully signed up for the auction." 
        />
      )}
       {signUpState===false && (
        <FailureBox 
